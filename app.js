document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateDailyRoutine(lvl, equip, gender, health) {
        ...
        const images = {
            mujer: {
                warmupHead: ['assets/img_f_warm_head1.png', 'assets/img_f_warm_head2.png'],
                warmupArms: ['assets/img_f_warm_arms1.png', 'assets/img_f_warm_arms2.png'],
                warmupTorso: ['assets/img_f_warm_torso1.png', 'assets/img_f_warm_torso2.png'],
                warmupLegs: ['assets/img_f_warm_legs1.png', 'assets/img_f_warm_legs2.png'],
                escoba: ['assets/img_f_escoba1.png', 'assets/img_f_escoba2.png'],
                stairs: ['assets/img_f_stairs1.png', 'assets/img_f_stairs2.png'],
                bike: ['assets/img_f_bike1.png', 'assets/img_f_bike2.png'],
                eliptica: ['assets/img_f_treadmill1.png', 'assets/img_f_treadmill2.png'],
                treadmill: ['assets/img_f_treadmill1.png', 'assets/img_f_treadmill2.png'],
                jacks: ['assets/img_f_jacks1.png', 'assets/img_f_jacks2.png'],
                weights: ['assets/img_f_weights1.png', 'assets/img_f_weights2.png'],
                bands: ['assets/img_f_bands1.png', 'assets/img_f_bands2.png'],
                chair: ['assets/img_f_chair1.png', 'assets/img_f_chair2.png'],
                mochila: ['assets/img_f_backpack1.png', 'assets/img_f_backpack2.png'],
                mochilaRow: ['assets/img_f_backpack_row1.png', 'assets/img_f_backpack_row2.png'],
                pushups: ['assets/img_f_pushups1.png', 'assets/img_f_pushups2.png'],
                plank: ['assets/img_f_plank1.png', 'assets/img_f_plank2.png'],
                stretch: ['assets/img_f_stretch1.png', 'assets/img_f_stretch2.png'],
                geroWarmup: ['assets/img_f_gero_warm1.png', 'assets/img_f_gero_warm2.png'],
                geroLegs: ['assets/img_f_gero_legs1.png', 'assets/img_f_gero_legs2.png'],
                geroSitStand: ['assets/img_f_gero_sitstand1.png', 'assets/img_f_gero_sitstand2.png'],
                geroBalance: ['assets/img_f_gero_balance1.png', 'assets/img_f_gero_balance2.png'],
                geroStretch: ['assets/img_f_gero_stretch1.png', 'assets/img_f_gero_stretch2.png']
            },
            hombre: {
                warmupHead: ['assets/img_m_warm_head1.png', 'assets/img_m_warm_head2.png'],
                warmupArms: ['assets/img_m_warm_arms1.png', 'assets/img_m_warm_arms2.png'],
                warmupTorso: ['assets/img_m_warm_torso1.png', 'assets/img_m_warm_torso2.png'],
                ...
                stairs: ['assets/img_m_stairs1.png', 'assets/img_m_stairs2.png'],
                bike: ['assets/img_m_bike1.png', 'assets/img_m_bike2.png'],
                eliptica: ['assets/img_m_treadmill1.png', 'assets/img_m_treadmill2.png'],
                treadmill: ['assets/img_m_treadmill1.png', 'assets/img_m_treadmill2.png'],
                jacks: ['assets/img_m_jacks1.png', 'assets/img_m_jacks2.png'],
                weights: ['assets/img_m_weights1.png', 'assets/img_m_weights2.png'],
                bands: ['assets/img_m_bands1.png', 'assets/img_m_bands2.png'],
                chair: ['assets/img_m_chair1.png', 'assets/img_m_chair2.png'],
                mochila: ['assets/img_m_backpack1.png', 'assets/img_m_backpack2.png'],
                mochilaRow: ['assets/img_m_backpack_row1.png', 'assets/img_m_backpack_row2.png'],
                ...
                geroWarmup: ['assets/img_m_gero_warm1.png', 'assets/img_m_gero_warm2.png'],
                geroLegs: ['assets/img_m_gero_legs1.png', 'assets/img_m_gero_legs2.png'],
                geroSitStand: ['assets/img_m_gero_sitstand1.png', 'assets/img_m_gero_sitstand2.png'],
                geroBalance: ['assets/img_m_gero_balance1.png', 'assets/img_m_gero_balance2.png'],
                geroStretch: ['assets/img_m_gero_stretch1.png', 'assets/img_m_gero_stretch2.png']
            }
        };
